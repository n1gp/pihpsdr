...
BAND bands[BANDS+XVTRS] = 
    ...
    {{"12",&bandstack12,0,0,0,0,0,ALEX_ATTENUATION_0dB,53.0,24890000LL,24990000LL,0LL,0},
     ...
     {"AIR",&bandstackAIR,0,0,0,0,0,ALEX_ATTENUATION_0dB,53.0,108000000LL,137000000LL,0LL,0},
     {"WX",&bandstackWX,0,0,0,0,0,ALEX_ATTENUATION_0dB,53.0,162400000LL,162550000LL,0LL,0},
#endif
#ifdef LIMESDR
